"""
Command-Line Tool for varying the angle & flipped-ness of break block objects within a level

Break blocks can have 2 custom properties
1. angle 
2. flip_x
angle = [0, 90, 180, 270] angle degree will be randomly picked
flip_x = break blocks may or may not have this property (50% chance of having)
...
Pseudo Algo
1. scan level file for break_blocks
...
tool_desription = "Scans a level file for break blocks and apply the custom properties of flip_x and angle"
arg_help_level = "Name of the tiled level XML"
arg_help_all = "Scans ALL levels for break blocks and apply the custom properties of flip_x and angle"
...
def main():
    ...
    if args.all:
        multi.Init(VB.VaryBreakBlocksFromFile)
        ...
        print(f"Varying break blocks for {args.filename}")
    ...
    time.sleep(0.25)
    print("Finished varying all break blocks")
