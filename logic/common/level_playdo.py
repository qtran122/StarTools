    ...
    def GetTiles2d(self, tile_layer_name):
        ...
        for layer in self.level_root.findall('layer'):
            if tile_layer_name is None or layer.get('name') == tile_layer_name:
                ...
                tile_2d_map = math_utils.DecodeIntoTiles2d(data, self.map_width)
        ...
        raise Exception(f"level_playdo.py was requested a tile_layer '{tile_layer_name}' that does not exist!")
