...
class PatternMatcher():
    ...
    def LoadPattern(self, pattern_file_path):
        ...
        for layer in root.findall('layer'):
            ...
            tiles2d = math_utils.DecodeIntoTiles2d(encoded_string, pattern_width)
            tiles2d, rows_trimmed, cols_trimmed = math_utils.TrimTiles2d(tiles2d)
            ...
            #print("----------- pattern -----------")
            #math_utils.PrintTiles2d(tiles2d, True)
